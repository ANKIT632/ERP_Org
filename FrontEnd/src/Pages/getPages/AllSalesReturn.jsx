...
export default function AllSalesReturn() {
  ...
  const handleSaveClick = async () => {
    try {
      ...
      toast.success("Sales return Edited Successfully!");
      location.reload();
      setEditingIndex(null);
      setShowModal(false);
    } catch (error) {
      // console.error("Error updating sales return :", error);
      toast.error("Failed to edit sales Return");
    }
  };

  useEffect(() => {
    axios
      .get(`${import.meta.env.VITE_APP_BASE_URL}/sales-return`)
      .then((res) => {
        setSalesReturnData(res.data.response);
        const filteredData = res.data.response.filter(
          (salesReturn) => salesReturn._id === editingIndex
        );
    ...
    if (confirmDelete) {
      try {
        const res = await axios.delete(
          `${import.meta.env.VITE_APP_BASE_URL}/sales-return/${id}`
        );
  ...
  useEffect(() => {
      ...
      setSubTotal(
          editedInvoiceData.productQuantity * editedInvoiceData.productRate
        );
        setTaxAmount((subTotal * editedInvoiceData.taxPercentage)/100);
        setTotalAmount(subTotal - (subTotal * editedInvoiceData.taxPercentage)/100);
          ...
          <table className="w-full border rounded-md">
            <thead className="bg-blue-200 text-gray-800 text-sm sm:text-xs md:text-sm">
              <tr className="border-b border-gray-300 p-4">
                ...
                <th className="p-3  border border-gray-300">CN No</th>
                <th className="p-3  border border-gray-300">Customer</th>
                <th className="p-3  border border-gray-300">Taxable Amount</th>
            ...
            <tbody className="text-xs sm:text-xs md:text-sm">
              {salesReturnData.map((invoice, index) => (
                <tr
                  key={index}
                ...
                >
                  ...
                  <td className="p-2 border border-gray-300">{"Completed"}</td>
                  <td>
                    <span className=""></span>
                  </td>
                  <td>
                    <div className="dropdown flex flex-col bg-white items-center relative ">
                      ...
                      {openIndex === index && (
                        <ul className="menu  border bg-white rounded-md absolute right-0 top-[30px]">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="mb-4">
                        ...
                        <input
                          ...
                          className="p-2 border form-input bg-gray-200 cursor-pointer"
                        />
                      </div>
                      <div className="mb-4">
                        <label
                        ...
                        <input
                          ...
                          value={editedInvoiceData.creditDate}
                    ...
                    <div className="flex gap-4">
                      <div className="mb-4">
                        ...
                        <input
                          ...
                          value={editedInvoiceData.productName}
                          className="p-2 border form-input bg-gray-200 cursor-pointer"
                        />
                      </div>
                      <div className="mb-4">
                        ...
                        <input
                          ...
                          placeholder="Enter product Quantity"
                          value={editedInvoiceData.productQuantity}
                          onChange={handleOnchange}
                          className="p-2 border form-input"
                        />
                      </div>
                      <div className="mb-4">
                        ...
                        <input
                          ...
                          value={editedInvoiceData.productRate}
                          onChange={handleOnchange}
                          className="p-2 border form-input"
                        />
                      </div>
                      ...
                      <div className="grid grid-cols-3 gap-4 mb-4">
                        ...
                        <div className="col-span-2">
                          <div className="flex justify-between items-center mb-4">
                            <h2 className="text-xl font-bold">Sales Return Invoice</h2>
                          </div>
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                            ...
                            <div>
                              <h3 className="font-bold">
                                Ship to: {filterInvoiceData[0].customer}
                              </h3>
                              <p>MADHYA PRADESH</p>
